...
import { categories, brands, sizes } from "@/utils/config";
...
const ProductListingPage = (props: Props) => {
    ...
    const { products, isLoading, error, fetchProductFromFilters, totalPages, totalProducts, setCurrentPage, currentPage } = useProductStore();


    console.log("Products in listing page:", products);


    const fetchAllPro = async () => {
        fetchProductFromFilters({
            page: currentPage,
            limit: 3,
    ...
    useEffect(() => { fetchAllPro() }, [currentPage, selectedBrands, selectedCategories, selectedColors, selectedSizes, priceRange, sortBy, sortOrder]);
