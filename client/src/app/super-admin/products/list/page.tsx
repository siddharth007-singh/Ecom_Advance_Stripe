...
const SuperAdminProductsListPage = (props: Props) => {
  const router = useRouter();
  const productFetchRef = useRef(false);

  const { isLoading, error, products, fetchAllProductsForAdmin, deleteProduct } = useProductStore();
...
export default SuperAdminProductsListPage